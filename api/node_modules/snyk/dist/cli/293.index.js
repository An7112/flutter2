...
async function testEcosystem(ecosystem, paths, options) {
    ...
    if (common_2.isUnmanagedEcosystem(ecosystem)) {
        enhancedOptions.supportUnmanagedVulnDB = await feature_flags_1.hasFeatureFlag('snykUnmanagedVulnDB', options);
    }
    const readableResult = await plugin.display(scanResults, testResults, errors, enhancedOptions);
